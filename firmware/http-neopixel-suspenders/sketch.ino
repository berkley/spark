...
void loop()
{
    ...
    Serial.println("x[0]: " + String(x[0]));
    Serial.println("y[0]: " + String(y[0]));
    Serial.println("x[1]: " + String(x[1]));
    Serial.println("y[1]    : " + String(y[1]));
